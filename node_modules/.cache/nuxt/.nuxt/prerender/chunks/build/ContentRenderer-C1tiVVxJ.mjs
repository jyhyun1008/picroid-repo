import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { computed, toRaw, mergeProps, unref, resolveComponent, defineAsyncComponent, defineComponent, h, getCurrentInstance, reactive, watch, Text, Comment, useSSRContext } from 'file:///Users/jay/Documents/GitHub/commission/node_modules/vue/index.mjs';
...
import { pascalCase, kebabCase } from 'file:///Users/jay/Documents/GitHub/commission/node_modules/scule/dist/index.mjs';
import destr from 'file:///Users/jay/Documents/GitHub/commission/node_modules/destr/dist/index.mjs';
import { find, html } from 'file:///Users/jay/Documents/GitHub/commission/node_modules/property-information/index.js';
...
const HeroBackground = () => import('./HeroBackground-BU3CTqjb.mjs');
const UButton = () => import('./server.mjs').then((n) => n.T);
const UPageHero = () => import('./PageHero-ve-bQ665.mjs');
...
const localComponents = ["HeroBackground", "UButton", "UPageHero"];
const virtual_nuxt__2FUsers_2Fjay_2FDocuments_2FGitHub_2Fcommission_2Fnode_modules_2F_cache_2Fnuxt_2F_nuxt_2Fcontent_2Fcomponents = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  HeroBackground,
  UButton,
  UPageHero,
    ...
    function resolveVueComponent(component) {
      ...
      if (typeof component === "string") {
        ...
        if (globalComponents.includes(pascalCase(component))) {
          ...
          const loader = () => {
            return Promise.resolve().then(() => virtual_nuxt__2FUsers_2Fjay_2FDocuments_2FGitHub_2Fcommission_2Fnode_modules_2F_cache_2Fnuxt_2F_nuxt_2Fcontent_2Fcomponents).then((m) => {
...
//# sourceMappingURL=ContentRenderer-C1tiVVxJ.mjs.map
