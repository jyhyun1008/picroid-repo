...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, createError, getRequestHost, getRequestProtocol, getQuery as getQuery$1, removeResponseHeader, readBody, setHeader, getRouterParam, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, sendError, getRouterParams, getResponseStatusText, H3Error } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/@vue/shared/dist/shared.cjs.js';
import defu, { defuFn, defu as defu$1 } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/defu/dist/defu.mjs';
import { html as html$1 } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/satori-html/dist/index.js';
import sizeOf from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/image-size/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withBase, joinRelativeURL, withoutTrailingSlash, withoutProtocol, withTrailingSlash, hasProtocol, withHttps, withLeadingSlash, withoutLeadingSlash, decodePath } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/ufo/dist/index.mjs';
import consola, { createConsola, consola as consola$1 } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/consola/dist/index.mjs';
import { Launcher } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/chrome-launcher/dist/index.js';
import playwrightCore from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/playwright-core/index.mjs';
import { toValue, isVNode, isRef } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/vue/index.mjs';
import { stringify as stringify$1 } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/minimark/dist/stringify.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import destr, { destr as destr$1 } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/destr/dist/index.mjs';
import { parse, stringify, uneval } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/devalue/index.js';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/unhead/dist/server.mjs';
import { createStorage, prefixStorage, normalizeKey } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/unstorage/dist/index.mjs';
import lruCacheDriver from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/unstorage/drivers/lru-cache.mjs';
import { createHooks } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/node-mock-http/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/klona/dist/index.mjs';
import { snakeCase, pascalCase } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import { ErrorParser } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/source-map/source-map.js';
import { toHast } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/minimark/dist/hast.mjs';
import devalue from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/errx/dist/index.js';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, basename, isAbsolute } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/pathe/dist/index.mjs';
import process$1 from 'node:process';
import { renderToString } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/unhead/dist/utils.mjs';
import { getIcons } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/@iconify/utils/lib/index.js';
import { collections } from 'file:///Users/jay/Documents/GitHub/picroid-repo/.nuxt/nuxt-icon-server-bundle.mjs';
import localAdapter from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/db0/dist/connectors/better-sqlite3.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/ipx/dist/index.mjs';
import { createGenerator } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/@unocss/core/dist/index.mjs';
import presetWind from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/@unocss/preset-wind3/dist/index.mjs';
import { createUnhead } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/unhead/dist/index.mjs';
import { Resvg } from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/@resvg/resvg-js/index.js';
import _satori from 'file:///Users/jay/Documents/GitHub/picroid-repo/node_modules/satori/dist/index.js';

const serverAssets = [{"baseName":"nuxt-og-image:fonts","dir":"/Users/jay/Documents/GitHub/picroid-repo/.nuxt/cache/nuxt-og-image/_fonts"},{"baseName":"server","dir":"/Users/jay/Documents/GitHub/picroid-repo/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/jay/Documents/GitHub/picroid-repo","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/jay/Documents/GitHub/picroid-repo/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/jay/Documents/GitHub/picroid-repo/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/jay/Documents/GitHub/picroid-repo/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/jay/Documents/GitHub/picroid-repo/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/jay/Documents/GitHub/picroid-repo/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "nuxt-site-config": {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/jay/Documents/GitHub/picroid-repo/public"
      ]
    },
    "http": {
      "domains": []
...
const _2W3OtUbhXdzX63VQTIJSubl_57ZPqjRZNvjiXHMAc = (function(nitro) {
...
const _wGrCr2jtw6QSoVCUmSbKfpmJ8HmuLEcrawOp97Ja6Y = defineNitroPlugin((nitroApp) => {
...
const _gdpGh_7OZ_pkxDFAX3ZuBMfkahiWok6JFyPjH3sjkw = defineNitroPlugin(async (nitroApp) => {
...
const componentNames = [{"hash":"3WjFQtL4Ww14dJT-vzC-pgljVikKE-id0CV-AECyrxo","pascalName":"OgImageDocs","kebabName":"og-image-docs","path":"/Users/jay/Documents/GitHub/picroid-repo/app/components/OgImage/OgImageDocs.vue","category":"app"},{"hash":"lqi2TIJIQMafRl6atyAjEmgaOb13hjqfbfUGe7PXhOw","pascalName":"BrandedLogoDVue","kebabName":"branded-logo-d-vue","path":"/Users/jay/Documents/GitHub/picroid-repo/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/BrandedLogo.d.vue.ts","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"SOHaoKfoo4fUkREsCFGw8ewxkl4-XkkHkug2VwYRtFM","pascalName":"BrandedLogo","kebabName":"branded-logo","path":"/Users/jay/Documents/GitHub/picroid-repo/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/BrandedLogo.vue","category":"community"},{"hash":"BMTMwASJKH3AG9ey0Y845iqbPNO7HjNX5eW2U2psVTE","pascalName":"FrameDVue","kebabName":"frame-d-vue","path":"/Users/jay/Documents/GitHub/picroid-repo/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Frame.d.vue.ts","category":"community","credits":"@arashsheyda <https://github.com/arashsheyda>"},{"hash":"tFoYPh0fXaZR3uXybAqFEOGnQuQsvz-E-Yq-CtrFlIY","pascalName":"Frame","kebabName":"frame","path":"/Users/jay/Documents/GitHub/picroid-repo/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Frame.vue","category":"community"},{"hash":"XHXMYyA3oPy1eN81p4R-wv8k8tkHNooxhCRL8Zs1Pz0","pascalName":"NuxtDVue","kebabName":"nuxt-d-vue","path":"/Users/jay/Documents/GitHub/picroid-repo/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Nuxt.d.vue.ts","category":"community"},{"hash":"NPQTTXYQ8toXx5OaJ1VlRUUcxy1SNOxg-FoM7C08ZPM","pascalName":"Nuxt","kebabName":"nuxt","path":"/Users/jay/Documents/GitHub/picroid-repo/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Nuxt.vue","category":"community"},{"hash":"jGeID02J5-Tz9qaGIsRVZfJSXVQS9q-3V2Qnw65GQMg","pascalName":"NuxtSeoDVue","kebabName":"nuxt-seo-d-vue","path":"/Users/jay/Documents/GitHub/picroid-repo/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/NuxtSeo.d.vue.ts","category":"community"},{"hash":"VAHSTZlVcPHzkozocV1iTnwc4-YttdoOkHsYfoSgDZ4","pascalName":"NuxtSeo","kebabName":"nuxt-seo","path":"/Users/jay/Documents/GitHub/picroid-repo/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/NuxtSeo.vue","category":"community"},{"hash":"XHXMYyA3oPy1eN81p4R-wv8k8tkHNooxhCRL8Zs1Pz0","pascalName":"PergelDVue","kebabName":"pergel-d-vue","path":"/Users/jay/Documents/GitHub/picroid-repo/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Pergel.d.vue.ts","category":"community"},{"hash":"8CNn4yU043gQFqO-sZNDPz9GKED-h7ahXJ-61c9ThHM","pascalName":"Pergel","kebabName":"pergel","path":"/Users/jay/Documents/GitHub/picroid-repo/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Pergel.vue","category":"community"},{"hash":"7-N5uiZ77GftW16gAKUKdbC2kTqoiWjlYDsNWxCsCG4","pascalName":"SimpleBlogDVue","kebabName":"simple-blog-d-vue","path":"/Users/jay/Documents/GitHub/picroid-repo/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/SimpleBlog.d.vue.ts","category":"community"},{"hash":"b-Juo-FXQepo6SOCnA478MTAqbXNZuve6-MzHgTKA7s","pascalName":"SimpleBlog","kebabName":"simple-blog","path":"/Users/jay/Documents/GitHub/picroid-repo/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/SimpleBlog.vue","category":"community"},{"hash":"ahhiG3dVaeRX0C50qOnvcUsjBRro4ufe-6jzsUbVxBY","pascalName":"UnJsDVue","kebabName":"un-js-d-vue","path":"/Users/jay/Documents/GitHub/picroid-repo/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/UnJs.d.vue.ts","category":"community","credits":"UnJS <https://unjs.io/>"},{"hash":"vRUm5ru-64PEHIGsBby6-vCgLBg7iUJfvFKL6VuCXtI","pascalName":"UnJs","kebabName":"un-js","path":"/Users/jay/Documents/GitHub/picroid-repo/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/UnJs.vue","category":"community"},{"hash":"pzp5dWaNkZa2Gbj-RXhoDiBahvrINMjPJC9-Vs2OtxE","pascalName":"WaveDVue","kebabName":"wave-d-vue","path":"/Users/jay/Documents/GitHub/picroid-repo/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Wave.d.vue.ts","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"hq07GBU-Yd16ICfETt8SfSxfaYj3qBmDAiQkTcv89nw","pascalName":"Wave","kebabName":"wave","path":"/Users/jay/Documents/GitHub/picroid-repo/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Wave.vue","category":"community"},{"hash":"hsZbjduIx-cfHCcgbOY44VlwFWt5bfWv-VxiGiUifDs","pascalName":"WithEmojiDVue","kebabName":"with-emoji-d-vue","path":"/Users/jay/Documents/GitHub/picroid-repo/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/WithEmoji.d.vue.ts","category":"community","credits":"Full Stack Heroes <https://fullstackheroes.com/>"},{"hash":"zSwOodBXcjwS1qvFqGBJqitTEEnrvVfwQYkTeIxNpws","pascalName":"WithEmoji","kebabName":"with-emoji","path":"/Users/jay/Documents/GitHub/picroid-repo/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/WithEmoji.vue","category":"community"}];
...
const _G4WmImN1ZkaTjH_2pxO4mMeJYlC6taGRiQ82rMb3yVs = defineNitroPlugin(async (nitro) => {
  return;
});

const rootDir = "/Users/jay/Documents/GitHub/picroid-repo";
...
const _sqiwsd1MK6_AHyB3b9brNJcsNzRIaNM50c8pDV3W3OU = (nitroApp) => {
...
const _d3nofJHxEcXUSBLZZD1ZMKIz6rqKG6oT2jU0rqlexZw = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const plugins = [
  _2W3OtUbhXdzX63VQTIJSubl_57ZPqjRZNvjiXHMAc,
_wGrCr2jtw6QSoVCUmSbKfpmJ8HmuLEcrawOp97Ja6Y,
_gdpGh_7OZ_pkxDFAX3ZuBMfkahiWok6JFyPjH3sjkw,
_G4WmImN1ZkaTjH_2pxO4mMeJYlC6taGRiQ82rMb3yVs,
_sqiwsd1MK6_AHyB3b9brNJcsNzRIaNM50c8pDV3W3OU,
_d3nofJHxEcXUSBLZZD1ZMKIz6rqKG6oT2jU0rqlexZw
];
...
const _p6GqIn = eventHandler((event) => {
...
const getServerEntry = () => import('file:///Users/jay/Documents/GitHub/picroid-repo/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/jay/Documents/GitHub/picroid-repo/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _6f5J2c = defineCachedEventHandler(async (event) => {
...
const _CoZZsP = eventHandler(async (e) => {
  if (e.context._initedSiteConfig)
    return;
...
const _8LrIyM = eventHandler(async (e) => {
  const siteConfig = getSiteConfig(e);
  const nitroOrigin = getNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _nQtpcm = eventHandler(async (event) => {
...
const _NmJeZ7 = eventHandler(async (event) => {
  const options = useRuntimeConfig(event).llms;
  const contents = [];
  const llms = JSON.parse(JSON.stringify(options));
...
const _lzLSv5 = eventHandler(async (event) => {
  ...
  return await import('file:///Users/jay/Documents/GitHub/picroid-repo/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _2AF6uB = eventHandler(async (event) => {
...
const _XxAWPE = lazyEventHandler(() => {
...
const _lazy_1ZXF3r = () => Promise.resolve().then(function () { return ____slug__md_get$1; });
const _lazy_QtfNV9 = () => Promise.resolve().then(function () { return renderer$1; });
const _lazy_rlZqF5 = () => Promise.resolve().then(function () { return font$1; });
const _lazy_06uKvm = () => Promise.resolve().then(function () { return debug_json$1; });
const _lazy_wlorRW = () => Promise.resolve().then(function () { return image$1; });

const handlers = [
  { route: '', handler: _p6GqIn, lazy: false, middleware: true, method: undefined },
  { route: '/raw/**:slug.md', handler: _lazy_1ZXF3r, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_QtfNV9, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _6f5J2c, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/font/**', handler: _lazy_rlZqF5, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _CoZZsP, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _8LrIyM, lazy: false, middleware: false, method: undefined },
  { route: '/__og-image__/debug.json', handler: _lazy_06uKvm, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/image/**', handler: _lazy_wlorRW, lazy: true, middleware: false, method: undefined },
  { route: '/__og-image__/static/**', handler: _lazy_wlorRW, lazy: true, middleware: false, method: undefined },
  { route: '/llms.txt', handler: _nQtpcm, lazy: false, middleware: false, method: "get" },
  { route: '/llms-full.txt', handler: _NmJeZ7, lazy: false, middleware: false, method: "get" },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _lzLSv5, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _2AF6uB, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _XxAWPE, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_QtfNV9, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_QtfNV9, lazy: true, middleware: false, method: undefined }
];
